...
TASKER_API_URL="${TASKER_API_URL:-http://localhost:4200}"
GATSBY_TASKER_API_URL="${GATSBY_TASKER_API_URL:-$TASKER_API_URL}"

export VAULT_CONTENT_PATH
export VAULT_PATH="$VAULT_CONTENT_PATH"
export PORT
export TASKER_API_URL
export GATSBY_TASKER_API_URL
