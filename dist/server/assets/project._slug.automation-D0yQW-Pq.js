...
function ProjectAutomationRoute() {
  return /* @__PURE__ */ jsx(ProjectTabPlaceholder, { title: "Project Automation", description: "Project-linked pipelines, runs, schedules, and queue health will render here." });
}
export {
  ProjectAutomationRoute as component
};
