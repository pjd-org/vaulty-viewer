...
function ProjectRisksRoute() {
  return /* @__PURE__ */ jsx(ProjectTabPlaceholder, { title: "Project Risks", description: "Risk summaries, momentum changes, and mitigation plans will render here." });
}
export {
  ProjectRisksRoute as component
};
