...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-Cp5ZRxo0.js");
...
async function loadEntries() {
  const routerEntry = await import("./assets/router-Dve3S_a4.js").then((n2) => n2.ab);
  return {
    startEntry: await import("./assets/start-Df-7erhh.js"),
    routerEntry
  };
}
function getEntries() {
...
var ROUTER_BASEPATH = "_viewer";
var SERVER_FN_BASE = "/_viewer/_serverFn/";
