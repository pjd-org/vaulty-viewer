...
import { Dialog, DialogTitle, DialogContent, DialogTrigger } from '@/app/components/ui/dialog';
...
const AttachmentRemove: FC = () => {
  return (
    <AttachmentPrimitive.Remove asChild>
      <TooltipIconButton
        tooltip="Remove file"
        className="aui-attachment-tile-remove absolute top-1.5 right-1.5 size-3.5 rounded-full bg-[var(--surf-elevated)] text-muted-foreground opacity-100 shadow-sm hover:bg-[var(--surf-elevated)]! [&_svg]:text-black hover:[&_svg]:text-destructive"
        side="top"
      >
