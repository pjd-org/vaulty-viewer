    ...
    variants: {
      variant: {
        ...
        primary: cn(
          ...
          'shadow-[0_4px_20px_color-mix(in_srgb,var(--vault-accent)_40%,transparent)]',
          'hover:shadow-[0_4px_30px_color-mix(in_srgb,var(--vault-accent)_60%,transparent)]',
          'before:absolute before:inset-0 before:rounded-xl',
        ...
        destructive: cn(
          ...
          'shadow-[0_4px_16px_color-mix(in_srgb,var(--vault-danger)_30%,transparent)]',
