...
export function useNotification() {
  ...
  if (!context) {
    throw new Error(
      'useNotification must be used within a GlassNotificationProvider'
    );
  }
  return context;
}
        ...
        >
          ...
          <div className="relative p-4 flex items-start gap-3">
            ...
            <button
              ...
              className="shrink-0 p-1.5 rounded-lg text-white/60 hover:text-white hover:bg-white/10 transition-colors cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30"
            >
              <X className="w-4 h-4" />
            </button>
          </div>
