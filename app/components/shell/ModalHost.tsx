        ...
        <Dialog.Portal>
          ...
          <Dialog.Content
            className={cn(
              ...
              'w-full max-w-md rounded-[20px] border border-white/10 bg-[#0f1117] p-6 shadow-2xl',
          ...
          >
            ...
            <Dialog.Close asChild>
              <button
                ...
                className="absolute right-4 top-4 rounded-full p-1 text-slate-500 hover:text-slate-300 transition-colors"
              >
                ✕
              </button>
            </Dialog.Close>
