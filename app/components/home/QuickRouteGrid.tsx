  ...
  return (
    <div className="grid grid-cols-2 gap-3">
      ...
      >
        ...
        <p className="text-xs text-slate-600 mt-0.5">Projects & tasks</p>
      </Link>
      ...
      >
        ...
        <p className="text-xs text-slate-600 mt-0.5">Triage queue</p>
      </Link>
      ...
      >
        ...
        <p className="text-xs text-slate-600 mt-0.5">Guided assistant</p>
      </Link>
