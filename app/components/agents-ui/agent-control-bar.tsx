...
import { AgentDisconnectButton } from '@/app/components/agents-ui/agent-disconnect-button';
import { AgentTrackControl } from '@/app/components/agents-ui/agent-track-control';
import {
  AgentTrackToggle,
  agentTrackToggleVariants,
} from '@/app/components/agents-ui/agent-track-toggle';
...
} from '@/app/hooks/agents-ui/use-agent-control-bar';
  ...
  return (
    ...
    >
      <motion.div
        ...
        {...({
          inert: !(isChatOpen || isChatOpenUncontrolled) ? '' : undefined,
        } as any)}
