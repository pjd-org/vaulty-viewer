    ...
    <div className="fixed inset-0 z-50">
      ...
      <div
        ...
        style={{
          ...
          height: targetRect.height + padding * 2,
          boxShadow:
            '0 0 0 2px color-mix(in srgb, var(--vault-accent) 50%, transparent), 0 0 20px color-mix(in srgb, var(--vault-accent) 30%, transparent)',
        }}
      />
            ...
            <div className="relative">
              ...
              <div className="flex items-center justify-between mb-2">
                ...
                <button
                  onClick={handleClose}
                  aria-label="Close"
                  className="p-1 rounded-lg text-white/60 hover:text-white hover:bg-white/10 transition-colors cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30"
                >
                  <X className="w-4 h-4" />
                </button>
              </div>
              ...
              <div className="flex items-center justify-between">
                <button
                  ...
                  className={cn(
                    ...
                    currentStep === 0
                      ...
                      : 'text-white/60 hover:text-white hover:bg-white/10 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30'
                  )}
                >
                ...
                <button
                  ...
                  className={cn(
                    ...
                    'hover:from-cyan-400 hover:to-blue-400 transition-all cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30'
                  )}
                >
