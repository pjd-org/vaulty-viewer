  ...
  return (
    <div className="route-modal-overlay" onClick={closeOverlay}>
      <section
        ...
        aria-label="COD"
      >
        <button type="button" className="route-modal-close" onClick={closeOverlay} aria-label="Close COD">
          ✕
        </button>
        <div className="route-modal-scroll route-modal-body space-y-4">
          <header className="rounded-[28px] p-6 genie-surface genie-surface--hero genie-layer-hero">
            <div className="genie-content">
              <h1 className="text-3xl font-semibold tracking-tight text-slate-800">Readiness</h1>
              <p className="mt-2 text-sm text-slate-600">Can you work now, and under what constraints?</p>
            </div>
          </header>
          {summaryData?.summary && summaryData.summary.length > 0 && (
            <div className="genie-surface genie-surface--hero rounded-xl px-4 py-3 space-y-1.5">
              <div className="genie-content">
                <p className="text-xs font-semibold text-slate-300 uppercase tracking-wider">System State</p>
