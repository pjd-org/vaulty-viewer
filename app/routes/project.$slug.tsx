...
import { ProjectDetailScene } from '../components/projects/ProjectDetailScene';
  ...
  const summaryItems = [
    ...
    },
    {
      ...
      value:
        isLoading && !summarySurface
          ? 'Loading'
          : String(summarySurface?.pressureBand.length ?? 0),
    ...
    },
    {
      ...
      value:
        isLoading && !summarySurface
          ? 'Loading'
          : String(summarySurface?.decisionQueue.length ?? 0),
