...
function taskSeverityFromPriority(priority: number): 'critical' | 'high' | 'normal' {
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-3">
        ...
        <TaskSeverityBadge priority={task.priority} confidencePct={confidencePct} />
      </div>
...
function FocusRoute() {
  ...
  const [pendingExecutePath, setPendingExecutePath] = useState<string | null>(null);
        ...
        heroContent={
          <div className="space-y-5">
            <div className="grid gap-4 sm:grid-cols-3">
              <Link to="/work" className="rounded-xl border border-slate-200 bg-white/70 px-3 py-2 hover:bg-white/85">
              ...
              <Link to="/actions" className="rounded-xl border border-slate-200 bg-white/70 px-3 py-2 hover:bg-white/85">
                <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-slate-500">
                  Queue
                </p>
                <p className="mt-0.5 text-[1.65rem] leading-none font-semibold tabular-nums text-slate-800">
              ...
              <Link to="/portfolio" className="rounded-xl border border-slate-200 bg-white/70 px-3 py-2 hover:bg-white/85">
                <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-slate-500">
                  Portfolio
                </p>
                <p className="mt-0.5 text-[1.65rem] leading-none font-semibold tabular-nums text-slate-800">
            ...
            <div className="grid gap-8 sm:grid-cols-2">
              <div className="space-y-4">
                <Link to="/automation" className="block rounded-xl border border-slate-200 bg-white/70 px-3 py-2 hover:bg-white/85">
                  <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-slate-500">
                    Automation
                  </p>
                ...
                <Link to="/bubble" className="block rounded-xl border border-slate-200 bg-white/70 px-3 py-2 hover:bg-white/85">
                  <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-slate-500">
                    Bubble
                  </p>
                  <p className="mt-0.5 text-2xl font-semibold leading-none text-slate-800">
              ...
              <div className="space-y-4">
                <Link to="/knowledge" className="block rounded-xl border border-slate-200 bg-white/70 px-3 py-2 hover:bg-white/85">
                  <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-slate-500">
                    Knowledge
                  </p>
                  <p className="mt-0.5 text-2xl font-semibold leading-none text-slate-800">
                ...
                <Link to="/health" className="block rounded-xl border border-slate-200 bg-white/70 px-3 py-2 hover:bg-white/85">
                  <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-slate-500">
                    Health
                  </p>
                  <p className="mt-0.5 text-2xl font-semibold leading-none text-slate-800">
