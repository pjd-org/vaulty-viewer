  ...
  return (
    <nav className="navbar">
      ...
      <div className={`navbar__links ${menuOpen ? 'navbar__links--open' : ''}`}>
        ...
        <Link to="/kanban" activeClassName="navbar__link--active" onClick={closeMenu}>
          Kanban
        </Link>
        <Link to="/avatar" activeClassName="navbar__link--active" onClick={closeMenu}>
          Avatar
        </Link>
        <Link to="/goals" activeClassName="navbar__link--active" onClick={closeMenu}>
          Goals
        </Link>
        <Link to="/cod-status" activeClassName="navbar__link--active" onClick={closeMenu}>
          COD
        </Link>
      </div>
