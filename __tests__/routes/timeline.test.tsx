  ...
  events: [
    {
      ...
      src: { tool: 'aladdin' },
      meta: { run_id: 'run-abc-123', agent_id: 'primary-agent', agent_slot: 'primary' },
      data: { agent_id: 'primary-agent', caller_authority: 'user' },
    },
    {
      ...
      src: { tool: 'aladdin' },
      meta: { run_id: 'run-abc-123', agent_id: 'primary-agent', agent_slot: 'primary' },
      data: { agent_id: 'primary-agent', duration_ms: 1000, output_length: 42 },
    },
  ],
  total: 2,
  offset: 0,
